...
namespace DoctorConnect.Migrations
{
    ...
    [Migration("20260706170943_relative")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoctorConnect.Models.PermissionAuditLog", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("DoctorConnect.Models.Settings", b =>
                {
                    ...
                    b.Property<int>("NumberOfDaysToDisplay")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DoctorConnect.Models.PermissionAuditLog", b =>
                {
                    b.HasOne("DoctorConnect.Models.ApplicationUser", "ChangedByUser")
                        .WithMany("PermissionAuditLogs")
            ...
            modelBuilder.Entity("DoctorConnect.Models.RolePermission", b =>
                {
                    ...
                    b.HasOne("DoctorConnect.Models.Permission", "Permission")
            ...
            modelBuilder.Entity("DoctorConnect.Models.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("PermissionAuditLogs");
                });
