...
namespace DoctorConnect.Migrations
{
    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileName = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MedicalRecordId = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalAttachment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicalAttachment_MedicalRecords_MedicalRecordId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalAttachment_MedicalRecordId",
                table: "MedicalAttachment",
